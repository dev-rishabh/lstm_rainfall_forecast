...
@credit: Prof. Rajib Chattopadhyay
@note: This code is developed as a part of masters thesis with IMD, Pune and IITM Pune with Prof. Rajib Chattopadhyay
...
class predictions:
    ...
    class LSTM_Prediction:
        ...
        def plot_LSTM(self , dff, R_sqrd, R_mse, Corr, training_mae, validation_mae, training_mae_2, validation_mae_2, Rainfall_pred, Rainfall_pred_2, df_final):
            dist = self.district
...
if __name__ == '__main__':
    ...
    a = predictions.LSTM_Prediction('Patna', 'Rainfall', '40_years', 'Series')
    dff, R_sqrd, R_mse, Corr, training_mae, validation_mae , training_mae_2, validation_mae_2, Rainfall_pred, Rainfall_pred_2, df_final = a.model_training()
    a.plot_LSTM(dff, R_sqrd, R_mse, Corr, training_mae, validation_mae, training_mae_2, validation_mae_2, Rainfall_pred, Rainfall_pred_2, df_final)